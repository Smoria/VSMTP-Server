...
namespace VSMTP
{
    ...
    [ProvideToolWindow(typeof(MessagesToolbox))]
    public sealed class MainPackage : Package
    {
        /// <summary>
        /// MainPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "260503fc-58a3-42b8-8a88-4b8ecba1ee39";
        ...
        {
            base.Initialize();
            MessagesToolboxCommand.Initialize(this);
        }
